...
Route::group(['middleware' => ['auth', 'can:manage-user']], function(){
    ...
    Route::resource('/admin/frs-project-activities','Admin\Frs\FrsProjectActivityController', array('names' => 'admin.frs.project.activities'));
    Route::resource('/admin/frs-activities','Admin\Frs\FrsActivitiesController', array('names' => 'admin.frs.activities'));
    Route::resource('/admin/frs-category-cycle-phase','Admin\Frs\FrsCategoryCyclePhase', array('names' => 'admin.frs.category.cycle.phase'));
    Route::resource('/admin/frs-category','Admin\Frs\FrsCategory', array('names' => 'admin.frs.category'));
    Route::resource('/admin/frs-cycle','Admin\Frs\FrsCycle', array('names' => 'admin.frs.cycle'));
    Route::resource('/admin/frs-phase','Admin\Frs\FrsPhase', array('names' => 'admin.frs.phase'));
